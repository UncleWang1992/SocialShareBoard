//
//  ShareImageWithLabel.m
//
//  Created by 王双贵 on 2020/4/3.
...
@implementation ShareImageWithLabel

/**
 新建指定图片和文字的 ImageWithLabel
 */
+ (instancetype)imageLabelWithFrame:(CGRect)frame Image:(UIImage *)image LabelText:(NSString *)text {
    ShareImageWithLabel *view = [[self alloc] initWithFrame:frame Image:image LabelTest:text];
...
+(instancetype)imageLabelWithFrame:(CGRect)frame placeHolder:(UIImage *)placeHolder LabelText:(NSString *)text {
    ShareImageWithLabel *view = [[self alloc] initWithFrame:frame Image:placeHolder LabelTest:text ];
    view.placeHolder = placeHolder;
    return view;
}

- (ShareImageWithLabel *)initWithFrame:(CGRect)frame Image:(UIImage *)image LabelTest:(NSString *)text {
